...
--   - Ce script utilise ALTER TABLE IGNORE pour ignorer les erreurs de clés dupliquées
--     ce qui permet de le réexécuter sans erreur
-- ============================================================================

-- -------------------------------------------------------------------------
-- 1) ETAT DE BESOIN
-- -------------------------------------------------------------------------
ALTER TABLE IGNORE llx_apclogistics_etatbesoin
...
ALTER TABLE IGNORE llx_apclogistics_etatbesoin_lines
...
-- -------------------------------------------------------------------------
ALTER TABLE IGNORE llx_apclogistics_requisition
...
ALTER TABLE IGNORE llx_apclogistics_requisition_lines
...
-- 3) DEMANDE DE PRIX
-- -------------------------------------------------------------------------
ALTER TABLE IGNORE llx_apclogistics_demandeprix
...
ALTER TABLE IGNORE llx_apclogistics_demandeprix_lines
...
-- -------------------------------------------------------------------------
ALTER TABLE IGNORE llx_apclogistics_tokens
...
-- -------------------------------------------------------------------------
ALTER TABLE IGNORE llx_apclogistics_cotation
...
ALTER TABLE IGNORE llx_apclogistics_cotation_lines
...
-- 6) BON DE COMMANDE
-- -------------------------------------------------------------------------
ALTER TABLE IGNORE llx_apclogistics_boncommande
...
ALTER TABLE IGNORE llx_apclogistics_boncommande_lines
...
-- 7) BON DE RECEPTION
-- -------------------------------------------------------------------------
ALTER TABLE IGNORE llx_apclogistics_bonreception
...
ALTER TABLE IGNORE llx_apclogistics_bonreception_lines
...
-- -------------------------------------------------------------------------
ALTER TABLE IGNORE llx_apclogistics_stock
...
ALTER TABLE IGNORE llx_apclogistics_stock_movements
...
-- 9) DEMANDE D'AVANCE
-- -------------------------------------------------------------------------
ALTER TABLE IGNORE llx_apclogistics_demandeavance
...
ALTER TABLE IGNORE llx_apclogistics_demandeavance_lines
...
-- -------------------------------------------------------------------------
ALTER TABLE IGNORE llx_apclogistics_justifavance
...
ALTER TABLE IGNORE llx_apclogistics_justifavance_lines
...
-- -------------------------------------------------------------------------
ALTER TABLE IGNORE llx_apclogistics_demandepaiement
...
ALTER TABLE IGNORE llx_apclogistics_demandepaiement_lines
