...
if ($action === 'create' || $action === 'edit') {
    ...
    print '<div class="tabsAction" style="margin-top:24px;">';
    if ($id > 0) print '<a class="butAction" href="' . DOL_URL_ROOT . '/custom/apclogistics/demandepaiement_card.php?id=' . $object->id . '&action=generate_pdf&token=' . newToken() . '">' . $langs->trans('GeneratePDF') . '</a>';
